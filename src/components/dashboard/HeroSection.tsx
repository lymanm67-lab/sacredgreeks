    ...
    <div className="relative overflow-hidden rounded-3xl bg-gradient-hero p-8 md:p-12 shadow-2xl">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <p className="text-white/80 text-lg mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            Continue your journey of faith and fellowship with confidence.
          </p>
          
          {/* Daily Scripture */}
          <div className="glass-effect rounded-2xl p-6 animate-scale-in" style={{ animationDelay: '0.3s' }}>
            <div className="flex items-start gap-4">
              <div className="text-4xl text-foreground">"</div>
              <div className="flex-1">
                <p className="text-foreground text-base leading-relaxed mb-3 italic font-medium">
                  {dailyScripture.text}"
                </p>
