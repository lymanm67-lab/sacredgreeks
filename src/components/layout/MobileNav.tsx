...
const toolsNavItems = [
  ...
  { title: "Anti-Hazing", url: "/anti-hazing", icon: Ban, featureId: null, iconColor: "text-red-500" },
  { title: "Symbol Guide", url: "/symbol-guide", icon: ScrollText, featureId: null, iconColor: "text-fuchsia-500" },
  { title: "Myth Busters", url: "/myth-buster", icon: FileQuestion, featureId: null, iconColor: "text-orange-500" },
