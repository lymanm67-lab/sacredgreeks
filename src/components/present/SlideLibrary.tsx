...
const PROOF_TEMPLATES: Omit<SlideDeck, "id" | "user_id" | "created_at" | "updated_at">[] = [
  {
    ...
    is_public: true,
    slides_json: [
      { title: "The P.R.O.O.F. Framework", content: "Pledge Process · Rituals · Oaths · Obscurity · Founders\nBiblical Responses to Common Greek Life Criticisms", layout: "title", image_url: templateImages.proofFramework, notes: "Welcome everyone warmly. Set the stage: today we're walking through the P.R.O.O.F. framework — a structured, biblically-grounded approach to addressing the most common criticisms of Greek life. Remind the audience this is about equipping, not debating. Estimated time: 20-25 minutes total." },
      { title: "P — Pledge Process", content: "How does the intake and pledging process align with biblical values? Biblical mentorship involves testing character, not abusing it. Ancient trade guilds — including those Jesus and Paul belonged to — used structured apprenticeship and mentorship.", notes: "Address hazing concerns head-on. Distinguish between godly mentorship and abuse. Reference Hebrews 10:24-25 and Proverbs 27:17. Highlight that first-century trade guilds (τέκτων for Jesus, tentmaking for Paul) used structured training, evaluation, and mentorship — not degradation. Allow 4-5 minutes." },
      { title: "R — Rituals", content: "What rituals are involved and do they honor God? Not all ceremonies are worship. Many rituals focus on history, values, and commitment — like weddings or graduations. We discern based on content, not assumption.", notes: "This is the most sensitive slide — approach with care. Reference 1 Thessalonians 5:21: 'Test everything; hold fast what is good.' Explain the Power of Belief principle: rituals only hold spiritual power when the participant believes in their authority (1 Corinthians 8:4). Candles and robes are used in churches too — context determines meaning. Allow 4-5 minutes." },
      { title: "O — Oaths", content: "What oaths and vows are required of members? Using Greek letters doesn't mean worshiping Greek gods. Paul used Greek language and culture to spread the Gospel without endorsing paganism.", notes: "Reference Acts 17:22-28 where Paul engaged Greek culture at the Areopagus. He quoted their poets and found common ground. Using Greek letters is no different from using Roman numerals. Address Jesus' teaching on oaths: He warned against flippant oaths, not solemn commitments made in integrity — even God made covenant oaths (Hebrews 6:13-17). Allow 3-4 minutes." },
      { title: "O — Obscurity", content: "What is kept secret and does it conflict with walking in the light? Privacy is not secrecy. Jesus had inner-circle moments with Peter, James, and John. Private ceremonies can simply mean membership-only experiences.", notes: "Reference Mark 5:37 and Matthew 13:10-11 where Jesus taught some things privately. Not everything private is sinful — the Bible distinguishes between evil done in darkness and wisdom about sharing sacred moments. What matters is whether private practices align with Scripture, not whether they're public. Allow 3-4 minutes." },
      { title: "F — Founders", content: "What is the foundation and history of the organization? An organization's origin doesn't determine its current purpose. Many institutions with complex histories serve godly purposes today. We are new creations in Christ.", notes: "Reference 2 Corinthians 5:17 and Matthew 7:16-20. Many universities, hospitals, and denominations have evolved beyond their founders' original beliefs. God specializes in redemption. Address Masonic connection claims directly: judge by present fruit, not historical roots. Share your own story if comfortable. Allow 5 minutes including brief audience sharing." },
    ],
  },
  {
