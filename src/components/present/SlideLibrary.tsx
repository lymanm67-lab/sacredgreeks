...
const PROOF_TEMPLATES: Omit<SlideDeck, "id" | "user_id" | "created_at" | "updated_at">[] = [
  ...
  },
  {
    ...
    is_public: true,
    slides_json: [
      { title: "Servant Leadership Workshop", content: "Leading with Purpose, Serving with Heart", layout: "title" },
