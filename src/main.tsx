...
// Build ID is auto-generated by Vite at build time — no manual bumping needed
declare const __APP_BUILD_ID__: string;
const APP_SW_VERSION = typeof __APP_BUILD_ID__ !== 'undefined' ? __APP_BUILD_ID__ : Date.now().toString();
