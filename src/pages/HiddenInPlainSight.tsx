...
const DOUBLE_STANDARD_CONTENT = {
  ...
  points: [
    ...
    },
    {
      ...
      content: "Nearly every Western funeral tradition derives from pagan Roman and Greek death rituals.\n\n**Paragraph 1: Clothing, Processions & Burial Containers**\n\n**Wearing Black**: Roman mourners wore the 'toga pulla' (dark toga) to signify grief and ward off the spirits of the dead. The Greeks wore black or dark grey during the mourning period called 'penthos.' This practice predates Christianity by centuries. (Source: J.M.C. Toynbee, 'Death and Burial in the Roman World,' 1971)\n\n**Funeral Processions**: The Roman 'pompa funebris' featured a formal procession with the body carried through the streets, accompanied by musicians, professional mourners (praeficae), and family members. Torches were carried even during daylight to ward off evil spirits. (Source: Harriet Flower, 'Ancestor Masks and Aristocratic Power in Roman Culture,' 1996)\n\n**Coffins & Caskets**: The rectangular wooden coffin derives from Roman 'loculus' burial practices. The raised-lid casket design echoes Egyptian sarcophagi and Greek 'larnax' burial chests. Even the word 'sarcophagus' means 'flesh-eater' in Greek, referring to the limestone believed to dissolve bodies. (Source: Ian Morris, 'Death-Ritual and Social Structure in Classical Antiquity,' 1992)\n\n**Paragraph 2: Bearers, Meals & Grave Decorations**\n\n**Pallbearers**: Roman funerals required 'vespillones' (corpse-bearers) to carry the deceased. The number of bearers indicated social status—emperors required dozens. This hierarchical display of honor continues today. (Source: Valerie Hope, 'Roman Death,' 2009)\n\n**The Repass/Funeral Meal**: The Roman 'silicernium' was a feast held at the grave after burial, and the 'cena novendialis' (ninth-day feast) concluded the mourning period. Food offerings were left at graves during Parentalia and Lemuria festivals to feed ancestral spirits. Modern church repasses directly continue this tradition. (Source: John Bodel, 'Death and Social History,' 2000)\n\n**Flowers & Wreaths**: Romans decorated graves with roses, violets, and wreaths during Rosalia/Rosaria festivals dedicated to the dead. The circular wreath symbolized eternity in pagan thought. (Source: Mary Beard, 'SPQR: A History of Ancient Rome,' 2015)\n\n**Paragraph 3: Eulogies & The Double Standard**\n\n**Eulogies**: The Roman 'laudatio funebris' (funeral oration) praised the deceased's virtues and ancestry. This practice was considered essential for the soul's journey to the afterlife. (Source: Cicero, 'De Oratore')\n\nChristians participate in every one of these pagan-derived practices without spiritual concern, yet question the rituals of organizations founded by Black Americans for mutual aid and community support.",
    },
  ],
