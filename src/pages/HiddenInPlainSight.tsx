...
const DOUBLE_STANDARD_CONTENT = {
  ...
  points: [
    ...
    },
    {
      ...
      content: "The Volkswagen emblem was designed during Nazi Germany under Adolf Hitler's regime. Ferdinand Porsche (1875–1951), who created the 'People's Car' (Volkswagen), was a Nazi party member and later founded the Porsche engineering firm in 1931, which produced the iconic Porsche 356 sports car. The same engineer behind the luxury Porsche brand used concentration-camp labor to build Hitler's 'People's Car.' Yet today, Christians drive Volkswagens and Porsches without moral concern—while simultaneously questioning whether Greek letter organization founders had Masonic affiliations. Sundials, still used decoratively in Christian gardens and churches, are direct relics of sun worship—yet no one questions their presence on church grounds. The double standard is glaring: car brands with documented Nazi origins receive no scrutiny, while organizations founded by Black Americans for mutual aid face endless interrogation about their founders' lodge memberships.",
    },
    {
