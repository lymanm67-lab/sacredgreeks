    ...
    if (RESEND_API_KEY && ADMIN_EMAIL) {
      ...
      const emailHtml = `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
          <div style="background: linear-gradient(135deg, #1a1a2e, #16213e); padding: 24px; border-radius: 12px; color: white; margin-bottom: 24px;">
            ...
            <p style="margin: 0; opacity: 0.8; font-size: 14px;">Auto-generated by Sacred Greeks AI Content Agent</p>
          </div>
          ...
          <div style="text-align: center; margin-bottom: 16px;">
            <a href="${siteUrl}/content-agent" target="_blank"
              ...
              ✏️ Review & Edit in Content Agent
            </a>
          </div>

          <p style="color: #999; font-size: 12px; text-align: center;">
            Sacred Greeks Life™ · AI Content Agent · Auto-generated ${new Date().toLocaleDateString()}
          </p>
        </div>
      `;
      ...
      try {
        const emailRes = await fetch("https://api.resend.com/emails", {
          ...
          body: JSON.stringify({
            from: "Sacred Greeks Content Agent <notifications@sacredgreeks.lovable.app>",
            to: [ADMIN_EMAIL],
